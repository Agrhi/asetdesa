    ...
    <div class="card">
        ...
        <div class="card-body">
            <div style="text-align: right;">
                <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#modaladdaset">Tambah Data</button>
            </div>
            <br>
            ...
            <table class="table" id="user">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $as->stok; ?></td>
                        <td>
                            <button class="btn icon btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#edit<?= $as->idaset ?>"><i class="bi bi-pencil"></i></button>
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('aset') ?>/add" method="POST">
                <div class="modal-body">
                    ...
                    <label>Stok : </label>
                    <div class="form-group">
                        <input type="text" class="form-control" name="stok" id="stok" placeholder="Stok" oninvalid="this.setCustomValidity('Username Wajib Di Isi !!!')" oninput="setCustomValidity('')" required>
                    </div>
                </div>
